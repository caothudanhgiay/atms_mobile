...
abstract class AppLocalizations {
  ...
  /// No description provided for @camera_request_title.
  ///
  /// In en, this message translates to:
  /// **'Camera permission required.'**
  String get camera_request_title;

  /// No description provided for @camera_request_content.
  ///
  /// In en, this message translates to:
  ...
  /// No description provided for @btn_open_setting.
  ///
  /// In en, this message translates to:
  /// **'Open Settings'**
  String get btn_open_setting;
  ...
  /// No description provided for @let_say.
  ///
  /// In en, this message translates to:
  /// **'Please speak...'**
  String get let_say;

  /// No description provided for @i_am_listening.
  ///
  /// In en, this message translates to:
  /// **'I\'m listening...'**
  String get i_am_listening;

  /// No description provided for @speak_or_type.
  ///
  /// In en, this message translates to:
  /// **'Speak or type'**
  String get speak_or_type;
